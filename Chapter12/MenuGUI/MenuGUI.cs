...
public class MenuGUI : Form {
	...
	private void InitializeComponents(MainApp ma){
		...
		ToolStripMenuItem addButtonItem = new ToolStripMenuItem("Button", null, new EventHandler(ma.AddButtonItemHandler));
		ToolStripMenuItem addTextBoxItem = new ToolStripMenuItem("TextBox", null, new EventHandler(ma.AddTextBoxItemHandler));
		
		
		ToolStripMenuItem addExitItem = new ToolStripMenuItem("Exit", null, new EventHandler(ma.AddExitItemHandler));
	...
	public void AddButton(MainApp ma){
		Button b = new Button();
		b.Text = "C# Rocks";
		b.Click += new EventHandler(ma.ButtonClickHandler);
		_panel.SuspendLayout();
	...
	public void AddTextBox(MainApp ma){
		...
		t.Text = "Default Text";
		t.Click += new EventHandler(ma.TextBoxClickHandler);
		_panel.SuspendLayout();
