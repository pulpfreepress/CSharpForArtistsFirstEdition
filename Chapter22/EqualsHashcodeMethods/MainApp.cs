...
public class MainApp {
  public static void Main(){
    PersonVO p1 = new PersonVO("Rick", "Warren", "Miller", PersonVO.Sex.MALE, new DateTime(1964, 3, 7));
    PersonVO p2 = new PersonVO(p1);
    PersonVO p3 = new PersonVO("Coralie", "Sarah", "Miller", PersonVO.Sex.FEMALE, new DateTime(1968, 4, 5));
    PersonVO p4 = null;
